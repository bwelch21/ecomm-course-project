      ...
      <div class="col-sm-4">
        <div class="panel panel-primary">
          ...
          <div class="panel-footer">
            ...
            <input type="hidden" name="data" value="QPbavyRKP7VXn5XCsEIphEI6dvCRgRkXNBhOkH9PiEN4ICTsetECbq8w2gFhW5LjfD9HeEN8x/2LDPIYdm1waQ93VjUSKOziJeTqrTVEv7s=" /><br>
            <div align="center"><input type="image" src="https://test.bitpay.com/img/button-large.png" border="1" name="submit" alt="BitPay, the easy way to pay with bitcoins." ></div>
</form>
          </div>
        </div>
      </div>
